        ...
        return (
            <div className="single-product row mx-0">
                <div className="product-img col-lg-5 px-0">
                    <img src={this.props.imageSrc} style={{height:"250px"}} />
                </div>
                <div className="product-content col-lg-7 py-3">
                    <div className='row'>
                        ...
                        <div className='col-4'>
                            <Rating
                                style={{zIndex:'0'}}
                                name='rate1'
                                defaultValue={parseFloat(this.props.ratingValue)}
                                readOnly={true}
                                precision={0.1}
                    ...
                    <div className='description-wrapper textShowOrigin' title={this.props.description.length > 100 ? this.props.description : ''}>
                        {
