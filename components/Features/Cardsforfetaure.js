...
export default function Card(){
    ...
    return(
        <div className="container cardmb" >
            ...
            <Grid container >
                <Grid item={true} md={4} lg={4} sm={12} xs={12} className="flexcontainer cardhover flexcontainerrelative cardm borderhover"  style={{justifyContent:"start"}}>
                    <div className="flexcontaineralign" >
                        <img src={Logo1} alt="" className="flexcontaineralignimage " ></img>
                    </div>
                    <div>
                        <div style={{marginTop:30,marginBottom:20}}>
                            <p style={{color:"black",fontWeight:1000}} className="cardtitlehover">Easy to Navigate
                            </p>
                        </div>
                ...
                <Grid item={true} md={4}lg={4} sm={12} xs={12} className="flexcontainer cardhover flexcontainerrelative cardm borderhover" style={{justifyContent:"start"}} >
                    ...
                    <div>
                        <div style={{marginTop:30,marginBottom:20}}>
                            <p style={{color:"black",fontWeight:1000}} className="cardtitlehover">Secure & reliable
                            </p>
                        </div>
                ...
                <Grid item={true} md={4}lg={4} sm={12} xs={12} className="flexcontainer cardhover flexcontainerrelative flexcontainerrelative cardm borderhover"  style={{justifyContent:"start"}}>
                    <div className="flexcontaineralign">
                        <img src={Logo3} alt="" className="flexcontaineralignimage"></img>
                    </div>
                    <div>
                        <div style={{marginTop:30,marginBottom:20}}>
                            <p style={{color:"black",fontWeight:1000}} className="cardtitlehover">Customisable</p>
                        </div>
