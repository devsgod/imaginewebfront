            ...
            <section className="feedback-area ptb-100 bg-gray pb-0">
                <div className="container ptb-100 pt-0">
                    <div className="row h-100 justify-content-center align-items-center">
                        ...
                        <div className="col-lg-5 col-md-12 settitle">
                            <h2 className="pb-3">{data[this.props.slug]["title"]}</h2>
                ...
                <div className="container ptb-100 pb-0">
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-6 industries-customer-img">
                        ...
                        <div className="col-lg-6 col-md-6 ptb-100 pt-2 settitle">
                            <h2>Manage you screens from anywhere in the world with the power of the Imagine Digital Signage Software</h2>
