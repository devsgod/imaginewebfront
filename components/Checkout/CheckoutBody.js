...
function CheckoutBody(props) {
    ...
    const onSaveData = () => {
        ...
        const cartData = props.cartData;
        const orderDetail = {
            payment: localStorage.getItem('paymentType'),
                                        ...
                                        {keys.map((data, idx) => (
                                            <tr key={idx}>
                                                ...
                                                <td style={{textAlign : 'center'}}>
                                                    <span className="subtotal-amount">R{props.cartData[data].price_rand}</span>
                                                </td>
                                                <td style={{textAlign : 'center'}}>
                                                    <span className="subtotal-amount">{props.cartData[data].quantity}</span>
                                                </td>
                                                <td style={{textAlign : 'center'}} className="product-total">
                                                    <span className="subtotal-amount">R{props.cartData[data].price_rand * props.cartData[data].quantity}</span>
                                                </td>
                                            </tr>
                                        ))}
                                        </tbody>
                                ...
                                <table className="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td className="order-subtotal-price">
                                            <span className="order-subtotal-amount">R{props.subTotal}</span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td className="product-subtotal">
                                            <span className="subtotal-amount">R{props.total}</span>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
