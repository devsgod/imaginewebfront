                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-7 col-sm-8 col-12">
                            <div className="contact-list">
                                ...
                                <Link href="mailto:info@imaginesignage.com"><a className="topbar-contact-email"><i className="icofont-envelope" style={{color:"white"}}></i> info@imaginesignage.com</a></Link>
                            </div>
                        </div>
