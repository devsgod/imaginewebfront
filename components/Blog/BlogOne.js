        ...
        return (
            <section className="blog-area blog-section ptb-100">
                ...
                <div className="container">
                    ...
                    <div className="row">
                        {
                            this.state.blogs_to_show.map( (blog,index) => (
                                <div key={index} className="col-lg-4 col-md-6">
                                    <div className="single-blog-post">
                                        <Link href={{ pathname:"/blog-details", query:{name:blog.title}}}>
                                            <a className="post-image blog-post-image">
                                                <div className="color-paper-red"></div>
                                        ...
                                        <div className="blog-post-content">
                                            ...
                                            <h3><Link href={{ pathname:"/blog-details", query:{name:blog.title}}}>
                                                <a>
                        ...
                        <div className="col-lg-12 col-md-12 text-center">
                            <button onClick={ (e) => this.loadMoreBlog()} className="btn btn-primary blog-more-btn">View more ➟</button>
