...
export const loadUser = () => (dispatch, getState) => {
  ...
  // Register User
  export const register = ({ username, email, password, firstName, lastName, mobile, accountname, businesstype, msg, companyName }) => dispatch => {
    // Headers
    const config_header = {
      headers: {
    ...
    // Request body
    const body = JSON.stringify({ username, email, password, firstName, lastName, mobile, accountname, businesstype, msg, companyName });
