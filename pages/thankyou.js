        ...
        return (
            <React.Fragment>
                ...
                <div className="thank-you-area">
                    <div className="container">
                        <h4 style={{lineHeight: "40px", fontSize:30}}>Thank you for registering. <br />  <br />
                            Please check your inbox folder. If you have not received an email, <br />
                            Please check your SPAM folder or <a href="/signup" ><h4 style={{color: "#fb6520", fontSize:30}}>click</h4></a> here to resend.</h4>
                        <Link href="/">
